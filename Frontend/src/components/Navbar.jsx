...
return ()=>{
  ...
  <div className="navbar-start">
    ...
    <a className="btn font-family-bold btn-ghost text-xl cursor-pointer">Bookstore</a>
  </div>
...
<label className="swap swap-rotate">
  ...
  <div className="">
    <a className="bg-black text-white p-2 rounded-md hover:bg-slate-800 duration:.3s cursor-pointer">Login</a>
  </div>
  </div>
</div>
    </div>
